...
const vbs = sys.createObject('scriptcontrol');
vbs.language = 'vbscript';
const jscript = sys.createObject('scriptcontrol');
...
function ToVBArray(length_or_array) {
    let dic = sys.createObject("Scripting.Dictionary");
